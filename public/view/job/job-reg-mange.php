                    ...
                    <div class="table-responsive">
                        <table id="data_table" class="table table-bordered table-striped" cellspacing="0">
                            ...
                            <tr>
                                ...
                                <td>'.$fetch_result['Priority_level'].'</td>
                                <td>'.$fetch_result['job_name'].'</td>
                                <td>'.$fetch_result['Customer_name'].'</td>
                                <td>'.$fetch_result['add_date_time'].'</td>
                                <td>'.$fetch_result['due_date'].'</td>
                                <td>
                                <a href="job-reg-edit.php?JC_ID='.$fetch_result['job_number'].'"><button type="button" class="btn btn-primary rounded-0" name="product_create">Edit</button></a>
                                <a href="pdf_generated_job_card.php?JC_ID='.$fetch_result['job_number'].'&ACTION=VIEW"><button type="button" class="btn btn-danger rounded-0" name="product_create">Job Card</button></a>
                                <a href="../invoice/qout.php?JC_ID='.$fetch_result['job_number'].'"><button type="button" class="btn btn-success rounded-0" name="product_create">Quotation</button></a>
                            </tr>';
                            }
                            echo'
