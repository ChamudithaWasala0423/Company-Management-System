...
<div class="container-fluid">
    ...
    <div class="page-title mb-4 d-flex align-items-center">
        <div class="mr-auto">
            <h4 class="weight500 d-inline-block pr-3 mr-3 border-right">Manage Inquiry</h4>
            <nav aria-label="breadcrumb" class="d-inline-block ">
                <ol class="breadcrumb p-0">
                    <li class="breadcrumb-item"><a href="#">Home</a></li>
                    <li class="breadcrumb-item"><a href="#">Job registration</a></li>
                    <li class="breadcrumb-item active" aria-current="page">Manage Inquiry</li>
                </ol>
            </nav>
        </div>
    </div>
            ...
            <div class="card card-shadow mb-4">
                <div class="card-header border-0">
                    <div class="custom-title-wrap bar-primary">
                        <div class="custom-title">Manage Inquiry</div>
                    </div>
                </div>
                    ...
                    <div class="table-responsive">
                        <table id="data_table" class="table table-bordered table-striped" cellspacing="0">
                            ...
                            <tr>
                                ...
                                <td>'.$fetch_result['location'].'</td>
                                <td>'.$fetch_result['Priority_level'].'</td>
                                <td>'.$fetch_result['description'].'</td>
                                <td>'.$fetch_result['add_date'].'</td>
                                <td><a href="inquiry-sheet-edit.php?JC_ID='.$fetch_result['inqury_id'].'"><button type="button" class="btn btn-primary rounded-0" name="product_create">Edit</button></a>
                            </tr>';
                            }
                            echo'
